...
class EmployeeRepository {
    ...
    public List<Employee> getAllEmployees() throws SQLException {
        ...
        try (Connection conn = connectionManager.getConnection();
            ...
            if (employees.isEmpty()) {
                employees.add(new Employee(1, "John Doe", "Senior Software Engineer", 85000.0));
                employees.add(new Employee(2, "Jane Smith", "Product Manager", 85000.0));
            }
    ...
    public Employee getEmployeeById(long id) throws SQLException {
        ...
        try (Connection conn = connectionManager.getConnection();
            ...
            // Mock data
            if (id == 1) {
                return new Employee(1, "John Doe", "Senior Software Engineer", 85000.0);
            } else if (id == 2) {
                return new Employee(2, "Jane Smith", "Product Manager", 85000.0);
            }
